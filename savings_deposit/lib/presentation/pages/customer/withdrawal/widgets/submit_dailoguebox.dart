                                    ...
                                    ColoredButton(
                                      press: () async {
                                        ...
                                        context.read<CustomerBloc>().add(
                                            CustomerEvent.withdrawalpostmethod(
                                                ...
                                                customerId: _loginDetails.userType ==
                                                        delegate
                                                            .withdrawalcustomer
                                                    ? context
                                                        .read<LoginBloc>()
                                                    ...
                                                    : _loginDetails.userType ==
                                                        ...
                                                        : "",
                                                realizationDate:
                                                    DateTime.parse(state.datepicker.toString()),
                                                ...
                                                tfrdta: otherBank.type == "GOLD_LOAN" ? account.accountNumber! + "\$" + goldloanno.text + "\$" + state.goldloansearchdatas!.intamt.toString() + "\$" + state.goldloansearchdatas!.seramt.toString() + "\$" + state.goldloansearchdatas!.advcharg.toString() + "\$" + state.goldloansearchdatas!.post.toString() + "\$" + state.goldloansearchdatas!.othercharge.toString() + "\$" + state.goldloansearchdatas!.otherexpense.toString() + "\$" + state.goldloansearchdatas!.interestwaive.toString() + "\$" + state.goldloansearchdatas!.intdt.toString() + "\$" + state.goldloansearchdatas!.otherexpensEPRINTOUT.toString() + "\$" + state.withdrawalAmount.round().toString() + "\$" + state.goldloansearchdatas!.settlementamount!.toString() + "\$" + state.goldloansearchdatas!.othercharge.toString() : "",
                                                statusAppWeb: "2"));
