...
const int headingHeightSize = 32;
const int subHeadingsSize = 24;
const int normalTextsize = 18;
const int scondLineSize = 10;
const int buttonTextSize = 24;
const int agentIdLength = 4;
const int employeeIdLength = 5;
...
const kWidth360 = SizedBox(width: 360);
