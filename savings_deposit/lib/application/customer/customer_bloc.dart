...
//////////////////////////////////////////////////////////////////////////////////////
    on<_Withdrawalpostmethod>((event, emit) async {
      ...
      Either<CustomerFailure, PostwithdrawalResponseDatamodel>
        ...
        sdno:
            state.customerOtherBankAccounts![state.otherbankindex].type == "RD"
                ? state.customerAccounts![state.accountCardIndex].accountNumber
                : "",
        phoneNo:
            state.customerOtherBankAccounts![state.otherbankindex].type == "RD"
                ? state.customerProfile!.mobileNumber1 ??
                    state.customerProfile!.mobileNumber2
                : "",
        tfrsdno:
            state.customerOtherBankAccounts![state.otherbankindex].type == "RD"
                ? state.sdsearchNo
        ...
        currinstno:
            state.customerOtherBankAccounts![state.otherbankindex].type == "RD"
                ? state.rdsearchDatas!.documentIDInfoList![0].installNo
                : 0,
...
//----------------searchSd card----in withdrawal-----------------------
    ...
    on<_RdinstallmentNo>((event, emit) async {
      ...
      final Either<CustomerFailure, RdinstallmentDatamodel>
    ...
    on<_SdsearchclearDatamodel>((event, emit) {
      emit(state.copyWith(
        ...
        rdsearchDatas: const RdDataModel(documentIDInfoList: [
          RdData(
              docId: "",
              branchId: -1,
              moduleId: 0,
        ...
        goldloansearchdatas: const GoldLoanSearchDataModel(
            ...
            totamt: 0,
            errMessage: ''),
        rdinstalmentdatas: const RdinstallmentDatamodel(status: 0.0),
        sdaccountdetailsFailureorSuccess: none(),
        goldLoandetailsFailureorSuccess: none(),
        rddetailsFailureorSuccess: none(),
        customerAccountSuccessOrfailOption: none(),
