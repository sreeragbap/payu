...
class PaymentEvent with _$PaymentEvent {
  ...
  const factory PaymentEvent.fetchPaymentTransactionCharges() =
      _fetchPaymentTransactionCharges;

  const factory PaymentEvent.selectPaymentMode({required String value}) =
      _SelectPaymentMode;

  const factory PaymentEvent.calculatePaymentPayableAmount(
      {required String amount,
      required String paymentMode}) = _CalculatePaymentPayableAmount;
